...
only when the scope is real and non-secret.
...
The completed dogfood audit found a real price-representation conflict in an
owner-controlled x402 API. It shows the report format without claiming a sale
or successful payment:

- [Public sample audit](public-sample-audit.md)
- [Machine-readable JSON summary](https://github.com/egoriklok/agent-fiscal-autonomy-pack/blob/main/deliverables/public-sample-audit-summary.json)
- [Proof of usefulness](proof-of-usefulness.md)

- [R1 portfolio product page RU](portfolio-r1-ru.html)
- [R1 portfolio text page RU](portfolio-r1-ru.md)
